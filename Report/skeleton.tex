...
The law of good continuation, seems to happen at earliest stages of our visual pipeline, with evidence pointing to the primary visual cortex(V1) \cite{field1993contour}. As suggested by  lead to the development of the "association fields" model. Association fields are defined as 
...
It is suggested that the continuous understanding of the whole happens in the early stages of vision
