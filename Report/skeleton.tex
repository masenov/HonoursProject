...
In order to perform our experiments we use a simple recurrent neural network. Given a single neuron we calculate its response by the formula. 

\eq{\cfrac{dr}{dt}=-r+in+mod}
...
In this section we discuss the performed experiments 	
