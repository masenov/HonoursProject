...
The smoothest curve connecting two bars can be described by the elastica principle(latin for 'thin strip'\cite{levien2008elastica}). Elastica has a long history dating back to as early as 13th century\cite{levien2008elastica}. Jordanus de Nemore posed the problem, but provided incorrect solution. A couple of centuries later after the necessary mathematical techniques were developed, the first solution was published by James Bernoulli in 1694. The elastica energy is then defined by the total curvature. The smoother curve they form, the more strongly they should be connected. The elatica curves with their respective energies are shown in fig.\ref{elastica1}.

\plotfiguresix{elastica1}{elastica5}{elastica3}{elastica4}{elastica2}{elastica6}{\bt{Elastica energies} Elastica energies for bar orientations a) 0 b) 6.98 c) 6.97 d) 5.23 e) 4 f) 9.98 (plots generated using \cite{elastica-code})}{.3}{Elastica principle}
